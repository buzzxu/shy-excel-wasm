...
// copy from https://github.com/golang/go/blob/master/misc/wasm/wasm_exec.js
(() => {
    const enosys = () => {
...
let _shyexcel = {
    ...
    _setting: null,
    _url: '',
    export: async function (fileName,urlOrData,params){
        try {
            ...
            setTimeout(() => {
                start(this._setting.tips.success, 2, buffer, fileName,'',_shyexcel)
                this._status = 2
            }, 50);
        } catch (error) {
            this.handleError(error);
